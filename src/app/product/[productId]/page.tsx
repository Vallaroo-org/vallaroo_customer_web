    ...
    return (
      <div className="flex min-h-screen flex-col bg-background">
        ...
        <main className="flex-1 container mx-auto px-4 py-8 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-muted-foreground mb-4">{t('productNotFoundDesc')}</p>
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-screen-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl mb-2">{productName}</h1>
            ...
            <div className="mt-auto space-y-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex-1 rounded-xl bg-gradient-to-r from-primary to-primary/90 px-8 py-4 text-base font-bold text-primary-foreground shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 border border-primary/20 min-h-[3.5rem]"
                >
                  {isAdded ? (
                    <>
                      <Check className="w-5 h-5 flex-shrink-0" />
                      <span className="whitespace-normal text-center leading-tight">{t('addedToCart')}</span>
                    </>
                  ) : (
                    <>
                      <ShoppingCart className="w-5 h-5 flex-shrink-0" />
                      <span className="whitespace-normal text-center leading-tight">{t('addToCart')}</span>
                    </>
                  )}
                </button>
                ...
                {product.shops?.phone_number ? (
                  <a
                    ...
                    className="flex-1 rounded-lg bg-green-600 px-8 py-4 text-base font-semibold text-white shadow-sm hover:bg-green-700 transition-colors flex items-center justify-center gap-2 min-h-[3.5rem]"
                  >
                    ...
                    <span className="whitespace-normal text-center leading-tight">{t('inquireWhatsapp')}</span>
                  </a>
                ) : (
                  <button disabled className="flex-1 rounded-lg bg-muted px-8 py-4 text-base font-semibold text-muted-foreground cursor-not-allowed flex items-center justify-center gap-2 min-h-[3.5rem]">
                    <span className="whitespace-normal text-center leading-tight">{t('inquiryUnavailable')}</span>
                  </button>
                )}
              </div>
            </div>
