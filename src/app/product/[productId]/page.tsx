            ...
            <div className="mt-auto space-y-4">
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 rounded-xl bg-gradient-to-r from-primary to-primary/90 px-8 py-4 text-base font-bold text-primary-foreground shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 border border-primary/20"
                >
                  {isAdded ? (
                    <>
                ...
                {product.shops?.phone_number ? (
                  <a
                    ...
                    className="flex-1 rounded-lg bg-green-600 px-8 py-4 text-base font-semibold text-white shadow-sm hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
                  >
                  ...
                  <button disabled className="flex-1 rounded-lg bg-muted px-8 py-4 text-base font-semibold text-muted-foreground cursor-not-allowed flex items-center justify-center gap-2">
                    {t('inquiryUnavailable')}
                  </button>
                )}
              </div>
            </div>
